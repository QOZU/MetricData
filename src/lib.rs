...
#[derive(Debug)]
pub struct MetricDataProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MetricDataProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MetricData processing");
    
    let mut processor = MetricDataProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MetricDataProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MetricDataProcessor::new(false);
